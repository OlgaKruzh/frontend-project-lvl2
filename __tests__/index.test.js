...
const expectedValue3 = fs.readFileSync("/home/olga/frontend-project-lvl2/__fixtures__/expectedResult.js", "utf8");
  ...
  test ('my first test', () => {
   ...
   // expect(genDiff(path1Absolute, path2Absolute)).toEqual(expectedValue2);
    expect(genDiff(path1Absolute, path2Absolute)).toEqual(expectedValue3);
